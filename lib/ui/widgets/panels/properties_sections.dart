                ...
                onChanged: (v) => onUpdate(
                  (s) => s.copyWith(
                      data: s.data.copyWith(
                          transform: s.transform.copyWith(x: v))),
                ),
              ),
              NumericInput(
                label: 'Y',
                ...
                onChanged: (v) => onUpdate(
                  (s) => s.copyWith(
                      data: s.data.copyWith(
                          transform: s.transform.copyWith(y: v))),
                ),
              ),
              NumericInput(
                label: 'W',
                ...
                onChanged: (v) => onUpdate(
                  (s) => s.copyWith(
                      data: s.data.copyWith(
                          transform: s.transform.copyWith(width: v))),
                ),
              ),
              NumericInput(
                label: 'H',
                ...
                onChanged: (v) => onUpdate(
                  (s) => s.copyWith(
                      data: s.data.copyWith(
                          transform: s.transform.copyWith(height: v))),
                ),
              ),
            ],
          ),
            ...
            children: [
              NumericInput(
                ...
                onChanged: (v) => onUpdate(
                  (s) => s.copyWith(
                      data: s.data.copyWith(
                          transform: s.transform.copyWith(rotation: v))),
                ),
              ),
                        ...
                        Expanded(
                          child: _SliderCompact(
                            ...
                            onChanged: (v) => onLiveUpdate(
                              (s) => s.copyWith(
                                  data: s.data.copyWith(opacity: v)),
                            ),
    ...
    return Column(
      children: [
          ...
          children: [
            ...
            ColorSwatchButton(
              ...
              onTap: () async {
                ...
                if (picked != null) {
                  onUpdate(
                    (s) => _updateFill(
                        s, i, s.fills[i].copyWith(
                            color: VecColor.fromFlutterColor(picked))),
                  );
                }
              },
            ),
            ...
            Expanded(
              child: _SliderCompact(
                ...
                onChanged: (v) => onLiveUpdate(
                  (s) => _updateFill(
                      s, i, s.fills[i].copyWith(opacity: v)),
                ),
                onChangeEnd: (_) => onCommit(),
              ),
            ),
        ...
        _BlendDropdown(
          ...
          theme: theme,
          onChanged: (mode) => onUpdate(
            (s) => _updateFill(
                s, i, s.fills[i].copyWith(blendMode: mode)),
          ),
        ),
      ],
    );
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            ...
            NumericInput(
              ...
              onChanged: (v) => onUpdate(
                (s) => _updateStroke(
                    s, i, s.strokes[i].copyWith(width: v)),
              ),
            ),
            const SizedBox(width: 8),
            Expanded(
              child: _SliderCompact(
                ...
                onChanged: (v) => onLiveUpdate(
                  (s) => _updateStroke(
                      s, i, s.strokes[i].copyWith(opacity: v)),
                ),
                onChangeEnd: (_) => onCommit(),
              ),
            ),
        ...
        Row(
          children: [
            _EnumToggle<VecStrokeCap>(
              ...
              theme: theme,
              onChanged: (v) => onUpdate(
                (s) => _updateStroke(s, i, s.strokes[i].copyWith(cap: v)),
              ),
            ),
            const SizedBox(width: 4),
            _EnumToggle<VecStrokeJoin>(
              ...
              theme: theme,
              onChanged: (v) => onUpdate(
                (s) => _updateStroke(s, i, s.strokes[i].copyWith(join: v)),
              ),
            ),
            const SizedBox(width: 4),
            _EnumToggle<VecStrokeAlign>(
              ...
              onChanged: (v) => onUpdate(
                (s) => _updateStroke(
                    s, i, s.strokes[i].copyWith(align: v)),
              ),
            ),
          ],
        ),
        ...
        _BlendDropdown(
          ...
          onChanged: (mode) => onUpdate(
            (s) => _updateStroke(
                s, i, s.strokes[i].copyWith(blendMode: mode)),
          ),
        ),
      ],
    );
  ...
  Widget build(BuildContext context) {
    return CollapsibleSection(
      ...
      content: _BlendDropdown(
        ...
        theme: theme,
        onChanged: (mode) => onUpdate(
          (s) => s.copyWith(data: s.data.copyWith(blendMode: mode)),
        ),
      ),
    );
  }
...
class _BlendDropdown extends StatelessWidget {
  ...
  static String _blendLabel(VecBlendMode m) {
    switch (m) {
      case VecBlendMode.normal: return 'Normal';
      case VecBlendMode.multiply: return 'Multiply';
      case VecBlendMode.screen: return 'Screen';
      case VecBlendMode.overlay: return 'Overlay';
      case VecBlendMode.darken: return 'Darken';
      case VecBlendMode.lighten: return 'Lighten';
      case VecBlendMode.colorDodge: return 'Color Dodge';
      case VecBlendMode.colorBurn: return 'Color Burn';
      case VecBlendMode.hardLight: return 'Hard Light';
      case VecBlendMode.softLight: return 'Soft Light';
      case VecBlendMode.difference: return 'Difference';
      case VecBlendMode.exclusion: return 'Exclusion';
      case VecBlendMode.hue: return 'Hue';
      case VecBlendMode.saturation: return 'Saturation';
      case VecBlendMode.color: return 'Color';
      case VecBlendMode.luminosity: return 'Luminosity';
    }
  }
}
